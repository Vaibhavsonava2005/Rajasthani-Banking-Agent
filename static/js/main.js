...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    ...
    'sample_csv': { en: 'Sample CSV', hi: 'नमूना CSV' },
    'total_records': { en: 'Total Customers', hi: 'कुल ग्राहक' },
    'total_loan': { en: 'Total Loan', hi: 'कुल लोन' },
    'total_paid': { en: 'Paid Loan', hi: 'जमा लोन' },
    'balance_due': { en: 'Remaining Balance', hi: 'बकाया राशि' },
    'upload_title': { en: 'Upload Customer File', hi: 'ग्राहक फ़ाइल अपलोड करें' },
    'upload_desc': { en: 'Upload Excel or CSV containing customer loan records. Required fields: Customer Name, Mobile Number, Bank Name, EMI Amount, Due Date, Total Loan, Paid Loan, Remaining Balance.', hi: 'ग्राहक ऋण रिकॉर्ड वाली Excel या CSV अपलोड करें। अनिवार्य: नाम, फोन, बैंक का नाम, EMI राशि, देय तिथि, कुल लोन, जमा लोन, बकाया लोन।' },
    'drop_primary': { en: 'Drag & Drop your Excel or CSV here', hi: 'अपनी Excel या CSV यहाँ छोड़ें' },
    'browse_btn': { en: 'Browse Files', hi: 'फ़ाइल चुनें' },
    'drop_secondary': { en: 'Supported Formats: CSV, XLSX, XLS. Maximum size: 16 MB.', hi: 'समर्थित प्रारूप: CSV, XLSX, XLS। अधिकतम आकार: 16 MB।' },
    'bank_all': { en: 'Choose Bank (All Banks)', hi: 'बैंक चुनें (सभी बैंक)' },
    'process_btn': { en: 'Generate AI Voice Messages', hi: 'AI आवाज़ संदेश जनरेट करें' },
    'processed_records': { en: 'Generated Voice Records', hi: 'जनरेट किए गए वॉइस रिकॉर्ड' },
    ...
    'nav_upload': { en: 'Upload Data', hi: 'डेटा अपलोड' },
    'nav_voice': { en: 'Voice Generation', hi: 'आवाज़ निर्माण' },
    'nav_campaigns': { en: 'Call Campaigns', hi: 'कॉल अभियान' },
    ...
    'nav_logout': { en: 'Logout', hi: 'लॉग आउट' },
    'header_title': { en: 'Upload Customer Data', hi: 'ग्राहक डेटा अपलोड करें' },
    'header_subtitle': { en: 'Automated EMI Reminder Platform', hi: 'स्वचालित EMI रिमाइंडर प्लेटफ़ॉर्म' },
    'step_1': { en: 'Step 1', hi: 'चरण 1' },
    'drop_or': { en: 'or', hi: 'या' },
    'select_bank': { en: 'Select Bank', hi: 'बैंक चुनें' },
    'processed_desc': { en: 'Review and execute automated calls for eligible customers.', hi: 'पात्र ग्राहकों के लिए स्वचालित कॉल की समीक्षा करें और निष्पादित करें।' },
